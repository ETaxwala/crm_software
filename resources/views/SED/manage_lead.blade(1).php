                                ...
                                <form id="updateLeadDetails" class="row g-3"
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-6">
                                                <label for="" class="visually-hidden">Service</label>
                                                <select name="service" id="service" class="form-control js-select2">
                                                    <option selected disabled>Select Service</option>
                                                    @foreach ($services as $service)
                                ...
                                <form id="addLeadFollowup" class="row g-3" action="{{ route('add-lead-followup') }}"
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <label for="" class="visually-hidden">Last Followup Remark</label>
...
<form id="addLeadOtherServices" class="row g-3"
                                    action="{{ route('add-lead-other-services') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                            <div class="col-9">
                                                <input type="hidden" id="lead_id4" name="lead_id4" value="">
                                                <label for="select2Field" class="visually-hidden">Select Service</label>
