...
<div class="ms-content-wrapper">
                                                ...
                                                <div class="card-body">
                                                    <div class="box box-primary direct-chat direct-chat-primary">
                                                        ...
                                                        <div class="box-footer">
                                                            ...
                                                            <form id="sendChatMsg"
                                                                action="{{ route('sm-customer-chatting') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <form id="documentUploads"
                                                action="{{ route('upload-sm-customer-documents') }}"
                                                method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form id="support_ticket_form" method="post"
                        action="{{ route('sm-customer-support-ticket') }}">
                        @csrf
    ...
    <script>
        ...
        function OpenChatBox(service_id) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('Get-SM-Emp-Chat-Details') }}",
                data: {
        ...
        function GetDocuments(service_id, customer_id) {
            // console.log(service_id);
            // console.log(customer_id);
            $.ajax({
                type: "GET",
                url: "{{ route('Get-SM-Customer-Documents') }}",
                data: {
                    service_id: service_id,
                    customer_id: customer_id
                },
        ...
        function GetCustomerWorkTimeline(service_id) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('Get-SM-Customer-Work-Timeline') }}",
                data: {
                    service_id: service_id,
                    customer_id: customer_id
                },
