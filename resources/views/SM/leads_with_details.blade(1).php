        ...
        <div class="col-md-12">
            <div class="ms-panel ms-panel-fh ms-btn-display">
                <div class="ms-panel-header">
                    ...
                    <button type="button" class="btn btn-dark mb-2" name="button" onclick="GetFollowupCallsFilter()">Todays
                                            ...
                                            <div class="col-12" id="service-price">
                                                ...
                                                <input name="service_price" type="text"
                                                    ...
                                                    <label for="" class="visually-hidden">Payment Status<span
                                                        style="color: red">*</span></label>
                                                        <select name="payment_status" id="" class="form-control shadow-none">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        if (data == Number(
                                "{{ config('global.paid') }}")) {
                            return "<span class='badge bg-success me-1 text-white'>Paid</span>"
                        }
                        if (data == Number(
                                "{{ config('global.unpaid') }}")) {
                            return "<span class='badge bg-danger me-1 text-white'>Unpaid</span>"
                        }
                        if (data == Number(
                                "{{ config('global.pending') }}")) {
                            return "<span class='badge bg-warning me-1 text-white'>Pending</span>"
                        } else {
                            return "<span class='badge bg-danger me-1 text-white'>Cancle</span>"
                        }
