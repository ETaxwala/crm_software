        ...
        <div class="col-md-12">
            ...
            <div class="ms-panel">
                <div class="ms-panel-header d-flex justify-content-between">
                    <h6>Manage Franchise Partner's</h6>
                    <h6>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(164, 0, 50);">
                <h5 class="modal-title text-white" id="addEmployeeLabel">Add New Partner</h5>
            </div>
            <div class="modal-body">
                <form id="addNewEmployee" class="row g-3" action="{{ route('add-franchise-employee') }}" method="POST"
...
<script type="text/javascript">
    $(function() {
        var table = $('.data-table').DataTable({
            ...
            ajax: "{{ route('franchise-manage-employee') }}",
    ...
    // get user details
    function FranchiseEmployeeDetails(user_id) {
        console.log(user_id);
        $.ajax({
            type: "GET",
            url: "{{ route('Get-Franchise-Employee-Details') }}",
            data: {
                user_id: user_id
            },
