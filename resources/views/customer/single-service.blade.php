...
<div class="ms-content-wrapper">
                                ...
                                <div class="card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="box box-primary direct-chat direct-chat-primary">
                                                        ...
                                                        <div class="box-footer">
                                                            ...
                                                            <form id="sendChatMsg"
                                                                action="{{ route('customer-chatting') }}" method="post"
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="#" onclick="showRequiredDocs()"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="blue" class="bi bi-info-circle" viewBox="0 0 16 16">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <form id="documentUploads"
                                                action="{{ route('upload-customer-documents') }}" method="post"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
        ...
        <div class="modal-dialog modal-dialog-centered modal-min" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form id="support_ticket_form" method="post" action="{{ route('customer-support-ticket') }}">
                        @csrf
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="text-left">
                        ...
                        @for ($i = 0; $i < count($dataArray); $i += 2)
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="card-text"><span class="check"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <script>
        ...
        $(function() {
            ...
            GetCustomerWorkTimeline(service_id)
        });
        ...
        function OpenChatBox(service_id) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('Get-Emp-Chat-Details') }}",
                data: {
        ...
        function GetDocuments(service_id) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('Get-Customer-Documents') }}",
                data: {
                    service_id: service_id
                },
                success: function(data) {
        ...
        function GetCustomerWorkTimeline(service_id) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('Get-Customer-Work-Timeline') }}",
                data: {
                    service_id: service_id
                },
                success: function(data) {
