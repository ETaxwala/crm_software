...
<body>
    <div class="container">
        ...
        <footer class="checkout__buttons">
            <button class="btn btn__secondary"><a href="{{ route('franchise-partner-all-services') }}">Cancel</a></button>
            <button class="btn btn__primary">
                <form id="paymentForm" action="{{ route('partner-rx-pay') }}" method="POST">
                    @csrf
                    <script
