         ...
         <div class="row g-5">
             <div class="col-md-6 col-lg-6 col-xl-4">
                 <div class="footer-item d-flex flex-column">
                     ...
                     <a href=""><i class="fa fa-map-marker-alt me-2"></i> 301, Ashoka Residency, In Front Of Hotel Modi Grate, Beside Hotel Shidori Beed Bypass Road, Ch Sambhajinagar, Maharashtra 431001</a>
