    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-gradient-danger">
                <h5 class="modal-title text-white" id="addAdminLabel">Add New Category</h5>
            </div>
            <div class="modal-body">
                <form id="addService" class="row g-3" action="{{ route('add-company-category') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="">Caegory Name <span style="color: red">*</span></label>
                                <input value="" type="text" class="form-control border-none"
                                    name="category_name" placeholder="Caegory Name" required>
                            </div>
                            <br><br>
                            <div class="col-md-6">
